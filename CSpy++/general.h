...
constexpr unsigned int CS_VERSION_BUILD = 3;
constexpr unsigned int CS_VERSION_RELEASEDATE_YEAR = 2020;
constexpr unsigned int CS_VERSION_RELEASEDATE_MONTH = 3;
constexpr unsigned int CS_VERSION_RELEASEDATE_DAY = 9;
...
constexpr const wchar_t* CS_VERSION_FULL = L"0.0.1 Technical Preview Build 3";
